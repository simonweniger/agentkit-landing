...
export function SignUpForm() {
  ...
  return (
    ...
    <form action="https://submit-form.com/b138hxIb2" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"  target="_blank" className="relative isolate mt-8 flex items-center pr-1">
